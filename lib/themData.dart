...
class CustomColors {
  ...
  static Color pageBackgroundColor = Color.fromARGB(255, 4, 84, 32);
...
class GradientColors {
  ...
  static List<Color> AlarmCard = [
    Color.fromARGB(255, 74, 19, 85),
    Color.fromARGB(255, 21, 8, 103)
  ];
  static List<Color> DisableAlarmCard = [
    Color.fromARGB(255, 73, 69, 73),
    Color.fromARGB(255, 137, 136, 145)
  ];
}
